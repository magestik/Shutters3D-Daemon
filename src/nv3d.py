...
class shutters:
	...
	def set_rate(self,rate=120.0): # Set refresh rate	
		self.frameTime = int(1000000.0/rate)
		...
		# timeout
		timeout = int(rate * 4) # Wait 4 seconds before going into idle
		#self.write([0x01,0x1e,0x02,0x00,timeout,timeout>>8]) OverflowError: unsigned byte integer is greater than maximum
		self.write([0x01,0x1e,0x02,0x00,0x00,0x00]) # "0x00, 0x00" instead of timeout,timeout>>8
